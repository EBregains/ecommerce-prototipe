      ...
      <form>
        ...
        <input className="sr-only hidden" readOnly name="user_id" value={user_id} />
        {
          ...
          <div className="flex flex-col my-8 w-full">
            <label htmlFor="materiales" className="mb-2">Color: <span className="inline-block ml-1 font-semibold">{currentColor}</span></label>
            <ColorPickerList>
        ...
        }
        {
          ...
          <div className="flex flex-col my-8 w-full">
            <label htmlFor="materiales" className="mb-2">Material: <span className="inline-block ml-1 font-semibold">{currentMaterial}</span></label>
            <MaterialPickerList>
        ...
        <div className="mt-4 mb-2 flex justify-between items-end">
          <div>
            ...
            <div className="flex gap-1">
              ...
              <input id="quantity" name="quantity" type="number" className="rounded-sm appearance-none h-8 w-8 text-center text-sm border" value={quantity} min={1} max={20} required readOnly />
              <button
                onClick={() => setQuantity((prev) => (prev + 1))}
                type="button"
                className="size-8 rounded-sm flex items-center justify-center bg-gray-200"
        ...
        <button formAction={directCheckout} className={buttonVariants({
          size: 'lg',
